...
public class AchievementDisplayManager : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject contents; // 개개의 도전과제 항목을 표시하는 게임 오브젝트 프리팹
    ...
    private IEnumerator Init()
    {
        ...
        foreach (var key in AchievementSystem.Instance.achievements.Keys)
        {
            ...
            var achievement = AchievementSystem.Instance.achievements[key];
